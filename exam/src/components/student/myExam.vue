    ...
    <div class="wrapper">
      ...
      <ul class="paper" v-loading="loading">
        <li class="item" v-for="(item, index) in pagination.records" :key="index">
          ...
          <div class="adjust" v-if="item.isPost == 1">

            <div class="image">
              <img :src="require(`@/assets/img/`+ `${index + 15}` +`.jpg`)">
            </div>
            ...
            <div class="info">
              ...
              <div class="c"><i class="el-icon-collection-tag"></i>考试类型: {{item.type}}</div><br>
              <el-button size="small" type="primary" class="yuri" @click="toAnswer(item.examCode)">开始答题</el-button>
            </div>
...
#myExam {
  background: url("../../assets/img/landscape16.jpg");
