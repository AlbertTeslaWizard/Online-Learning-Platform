        ...
        <div class="right">
          ...
          <div class="content">
            ...
            <div v-if="currentType == 1">
              ...
              <div class="submit">
                <!--<el-button size="small" type="primary" @click="changeSubmit()">收藏</el-button>
                <el-button size="small" type="danger" @click="mark()">标记</el-button>-->
              </div>
              <div class="analysis" v-if="1">
                <ul>
            ...
            <div class="fill" v-if="currentType == 2">
              ...
              <div class="submit">
                <!--<el-button size="small" type="primary" @click="fillSubmit()">收藏</el-button>
                <el-button size="small" type="danger" @click="mark()">标记</el-button>-->
              </div>
              <div class="analysis" v-if="1">
                <ul>
            ...
            <div class="judge" v-if="currentType == 3">
              <el-radio-group v-model="judgeAnswer[index]" @change="getJudgeLabel" v-if="currentType == 3">
                ...
                <div class="submit">
                  <!--<el-button size="small" type="primary" @click="judgeSubmit()">收藏</el-button>
                  <el-button size="small" type="danger" @click="mark()">标记</el-button>-->
                </div>
