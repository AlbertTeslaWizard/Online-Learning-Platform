  ...
  <div class="add">
    ...
    <el-tab-pane name="first">
      ...
      <section class="append">
        <ul>
          <li>
            <span style="color: red">题目类型:</span>
          ...
          <li v-if="optionValue == '选择题'">
            <span  style="color: red">所属章节：</span>
            <el-input
              placeholder="请输入对应章节"
          ...
          <li v-if="optionValue == '选择题'">
            <span  style="color: red">难度等级:</span>
            <el-select v-model="postChange.level" placeholder="请选择难度等级" class="w150">
              <el-option
          ...
          <li v-if="optionValue == '填空题'">
            <span  style="color: red">难度等级:</span>
            <el-select v-model="postFill.level" placeholder="请选择难度等级" class="w150">
              <el-option
                v-for="item in levels"
                :key="item.value"
                :label="item.label"
          ...
          <li v-if="optionValue == '判断题'">
            <span style="color: red">难度等级:</span>
            <el-select v-model="postJudge.level" placeholder="请选择难度等级" class="w150">
              <el-option
                v-for="item in levels"
                :key="item.value"
                :label="item.label"
          ...
          <li v-if="optionValue == '选择题'">
            <span style="color: red">分值:&nbsp</span>
            <el-input
              placeholder="请输入题目分值"
          ...
          <li v-if="optionValue == '选择题'">
            <span  style="color: red">正确选项:</span>
            <el-select v-model="postChange.rightAnswer" placeholder="请选择正确答案" class="w150">
              <el-option
        ...
        <div class="change" v-if="optionValue == '选择题'">
          <div class="title">
            <el-tag type="warning">题目:</el-tag><span>请在输入框中输入题目内容</span>
            <el-input
              type="textarea"
              rows="4"
          ...
          <div class="title">
            <el-tag  type="warning">解析:</el-tag><span>请在输入框中输入题目解析</span>
            <el-input
              type="textarea"
              rows="4"
        ...
        <div class="change fill" v-if="optionValue == '填空题'">
          <div class="title">
            <el-tag  type="warning">题目:</el-tag><span>请在输入框输入题目内容</span>
            <el-input
              type="textarea"
              rows="4"
          ...
          <div class="fillAnswer">
            <el-tag>正确答案:</el-tag><span></span>
            <el-input v-model="postFill.answer" placeholder="请输入题目答案" clearable="">
            </el-input>
          </div>
          <div class="title analysis">
            <el-tag type="warning">解析:</el-tag><span>请在输入框中输入答案解析</span>
            <el-input
              type="textarea"
              rows="4"
